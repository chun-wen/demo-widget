...
export const ADD_OLD_USER_MESSAGE = 'ADD_OLD_USER_MESSAGE';
export const EMIT_NEW_USER_MESSAGE = 'EMIT_NEW_USER_MESSAGE';
export const ADD_NEW_RESPONSE_MESSAGE = 'ADD_NEW_RESPONSE_MESSAGE';
export const ADD_OLD_RESPONSE_MESSAGE = 'ADD_OLD_RESPONSE_MESSAGE';
export const ADD_ALL_OLD_MESSAGE = 'ADD_ALL_OLD_MESSAGE';
